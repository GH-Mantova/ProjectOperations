...
SHAREPOINT_SITE_HOSTNAME=        # live only — e.g. initialservices.sharepoint.com
SHAREPOINT_SITE_PATH=            # live only — e.g. /sites/Initialservices
SHAREPOINT_LIBRARY_NAME=         # live only — e.g. Documents
SHAREPOINT_TENDERS_ROOT=         # live only — e.g. 1. Operations/1. Tenders
...
AZURE_MAIL_TENANT_ID=            # live mail only
