...
export class PortalClientController {
  ...
  @ApiResponse({ status: 200, description: "Portal dashboard counts." })
  @Get("dashboard")
  ...
  @ApiResponse({ status: 200, description: "List projects for the portal client." })
  @Get("projects")
  ...
  @ApiResponse({ status: 200, description: "Get a single project (scoped to client)." })
  @Get("projects/:id")
  ...
  @ApiResponse({ status: 200, description: "List jobs for the portal client." })
  @Get("jobs")
  ...
  @ApiResponse({ status: 200, description: "List quotes for the portal client." })
  @Get("quotes")
  ...
  @ApiResponse({ status: 200, description: "List documents for the portal client." })
  @Get("documents")
  ...
  @ApiResponse({ status: 200, description: "Get the portal user's account details." })
  @Get("account")
