...
import { AnthropicKeyMissingError, TenderScopeDraftingService } from "./tender-scope-drafting.service";
...
export class TenderScopeDraftingController {
  ...
  @ApiResponse({ status: 412, description: "api_key_required — Anthropic API key not configured." })
  async draft(
        ...
        throw new HttpException(
          {
            ...
            message: "Anthropic API key not configured. Go to Admin → Platform settings to add your key."
          },
