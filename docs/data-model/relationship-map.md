...
3. [Domain index](#domain-index)
    ...
    22. [Unclassified (11)](#domain-unclassified)
...
- **Unclassified** (11): AccessRequest, BrandAsset, BrandColorScheme, Commitment, CommitmentChange, CommitmentItem, CompanyLegalDocument, CompanyProfile, CorrectiveAction, DailyDiary, OperationsSettings
...
- Table: `assets` | Domain: Assets | Fields: 26
- Belongs to (FK out):
...
- Table: `jobs` | Domain: Jobs | Fields: 33
- Belongs to (FK out):
...
- Referenced by: **Commitment**, **CorrespondenceThread**, **FormSubmission**, **JobActivity**, **JobCloseout**, **JobConversion**, **JobIssue**, **JobProgressEntry**, **JobStage**, **JobStatusHistory**, **JobVariation**, **Project**, **Shift**
...
- Table: `users` | Domain: Platform | Fields: 124
- Belongs to (FK out):
  - `createdBy` -> **User** (createdById)
  - `updatedBy` -> **User** (updatedById)
...
- Table: `projects` | Domain: Projects | Fields: 56
- Belongs to (FK out):
  - `sourceTender` -> **Tender** (sourceTenderId, onDelete SetNull)
...
- Has one (back-relation):
  ...
  - `contract` -> **Contract**
- Referenced by: **Contract**, **DailyDiary**, **GanttTask**, **HazardObservation**, **Job**, **PreStartChecklist**, **ProjectActivityLog**, **ProjectAllocation**, **ProjectMilestone**, **ProjectScopeItem**, **SafetyIncident**, **ScheduleAllocation**, **TenderDocumentLink**, **Timesheet**
...
- Table: `sites` | Domain: Sites | Fields: 17
- Belongs to (FK out):
  - `client` -> **Client** (clientId, onDelete SetNull)
- Has many:
  - `jobs` -> **Job**[]
  ...
  - `tenders` -> **Tender**[]
  - `dailyDiaries` -> **DailyDiary**[]
- Referenced by: **DailyDiary**, **FormSubmission**, **Job**, **Project**, **Tender**
...
- Table: `operations_settings` | Domain: Unclassified | Fields: 8
- Belongs to (FK out):
  - `updatedBy` -> **User** (updatedById, onDelete SetNull)
- Suggested measures: fuelPricePerLitre, travelRatePerKm
- Suggested dimensions: updatedBy
