...
- Last updated: 2026-07-15 12:17 UTC
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `9d8e28ca03fe`)
- Models: 196 | Enums: 25 | FK edges: 288 | Domains: 23
...
3. [Domain index](#domain-index)
    ...
    22. [Unclassified (3)](#domain-unclassified)
...
- **Unclassified** (3): AccessRequest, CompanyLegalDocument, CompanyProfile
