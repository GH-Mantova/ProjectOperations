...
- Last updated: 2026-07-16 00:55 UTC
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `042e5df35303`)
- Models: 198 | Enums: 25 | FK edges: 289 | Domains: 23
...
3. [Domain index](#domain-index)
    ...
    22. [Unclassified (4)](#domain-unclassified)
...
- **Forms** (14): FormApproval, FormAttachment, FormContentSnippet, FormField, FormRule, FormSchedule, FormSection, FormSignature, FormSubmission, FormSubmissionValue, FormTemplate, FormTemplateVersion, FormTriggeredRecord, PreStartChecklist
...
- **Unclassified** (4): AccessRequest, CompanyLegalDocument, CompanyProfile, OperationsSettings
...
- Table: `users` | Domain: Platform | Fields: 116
- Belongs to (FK out):
  - `createdBy` -> **User** (createdById)
  - `updatedBy` -> **User** (updatedById)
