...
- Last updated: 2026-07-16 04:13 UTC
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `460e7fca8b47`)
- Models: 198 | Enums: 26 | FK edges: 292 | Domains: 23
...
- **Unclassified** (5): AccessRequest, CompanyLegalDocument, CompanyProfile, OperationsSettings, PaymentSchedule
...
- Table: `progress_claims` | Domain: Contracts | Fields: 19
- Belongs to (FK out):
...
- Referenced by: **ClaimLineItem**, **PaymentSchedule**
