...
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `524c656c2214`)
- Models: 200 | Enums: 26 | FK edges: 294 | Domains: 23
...
3. [Domain index](#domain-index)
    ...
    22. [Unclassified (7)](#domain-unclassified)
...
- **Unclassified** (7): AccessRequest, CompanyLegalDocument, CompanyProfile, Docket, DocketAttachment, DocketNumberSequence, OperationsSettings
...
- Table: `assets` | Domain: Assets | Fields: 27
- Belongs to (FK out):
...
- Has many:
  ...
  - `dockets` -> **Docket**[]
- Referenced by: **AssetBreakdown**, **AssetInspection**, **AssetMaintenanceEvent**, **AssetMaintenancePlan**, **AssetStatusHistory**, **Docket**, **FormSubmission**, **ProjectAllocation**, **ScheduleAllocation**, **ScopeOfWorksItem**, **ShiftAssetAssignment**
...
- Referenced by: **CorrespondenceThread**, **Docket**, **FormSubmission**, **JobActivity**, **JobCloseout**, **JobConversion**, **JobIssue**, **JobProgressEntry**, **JobStage**, **JobStatusHistory**, **JobVariation**, **Project**, **Shift**
...
- Table: `users` | Domain: Platform | Fields: 118
- Belongs to (FK out):
  - `createdBy` -> **User** (createdById)
  - `updatedBy` -> **User** (updatedById)
...
- Table: `workers` | Domain: Workers | Fields: 22
- Belongs to (FK out):
...
- Has many:
  ...
  - `formSubmissions` -> **FormSubmission**[]
  - `dockets` -> **Docket**[]
- Referenced by: **AvailabilityWindow**, **CrewWorker**, **Docket**, **FormSubmission**, **ShiftWorkerAssignment**, **WorkerCompetency**, **WorkerRoleSuitability**
