...
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `ecd1729ca3a2`)
- Models: 202 | Enums: 28 | FK edges: 303 | Domains: 23
...
3. [Domain index](#domain-index)
    ...
    22. [Unclassified (9)](#domain-unclassified)
...
- **Unclassified** (9): AccessRequest, Commitment, CommitmentChange, CommitmentItem, CompanyLegalDocument, CompanyProfile, CorrectiveAction, DailyDiary, OperationsSettings
