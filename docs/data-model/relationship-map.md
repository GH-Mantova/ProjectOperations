...
- Last updated: 2026-07-16 04:26 UTC
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `95d9d0416ffe`)
- Models: 199 | Enums: 25 | FK edges: 296 | Domains: 23
...
3. [Domain index](#domain-index)
    ...
    22. [Unclassified (5)](#domain-unclassified)
...
- **Unclassified** (5): AccessRequest, CompanyLegalDocument, CompanyProfile, DailyDiary, OperationsSettings
...
- Table: `sites` | Domain: Sites | Fields: 20
- Belongs to (FK out):
  - `client` -> **Client** (clientId, onDelete SetNull)
- Has many:
  - `jobs` -> **Job**[]
...
- Referenced by: **DailyDiary**, **FormSubmission**, **Job**, **Project**, **SiteGeofence**, **Tender**
