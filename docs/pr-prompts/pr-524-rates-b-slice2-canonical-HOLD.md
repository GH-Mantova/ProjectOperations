...
STATUS: DRAFTED, STAGED, DO NOT ARM YET. IRREVERSIBLE TABLE DROP. Cowork armed this by mistake in a batch sweep on 2026-07-20 and reverted it the same minute; the prompt itself forbids batch arming. Requires Marco's explicit confirmation in chat.
