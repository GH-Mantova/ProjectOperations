---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/dashboards/userDashboards.ts apps/web/src/dashboards/widgets/availabilityHeatmapWidget.tsx apps/web/src/dashboards/widgets/programSnapshotWidget.tsx apps/web/src/dashboards/widgets/projectTimeline.tsx apps/web/src/dashboards/widgets/safety.tsx'
premise_means: >-
  These 5 web files still feed a raw HTTP response body straight into an error
...
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/dashboards/userDashboards.ts apps/web/src/dashboards/widgets/availabilityHeatmapWidget.tsx apps/web/src/dashboards/widgets/programSnapshotWidget.tsx apps/web/src/dashboards/widgets/projectTimeline.tsx apps/web/src/dashboards/widgets/safety.tsx
size: 5
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Dashboard widgets

Slice 10 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (5 files, 7 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/dashboards/userDashboards.ts`  (3)
- `apps/web/src/dashboards/widgets/availabilityHeatmapWidget.tsx`  (1)
- `apps/web/src/dashboards/widgets/programSnapshotWidget.tsx`  (1)
- `apps/web/src/dashboards/widgets/projectTimeline.tsx`  (1)
- `apps/web/src/dashboards/widgets/safety.tsx`  (1)
