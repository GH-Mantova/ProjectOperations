---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/tendering/ScopeQuantitiesTable.tsx apps/web/src/pages/tendering/ScopeWasteTab.tsx apps/web/src/pages/tendering/TenderClarificationLog.tsx apps/web/src/pages/tendering/TenderDocumentsPanel.tsx apps/web/src/pages/tendering/TenderEntriesPanel.tsx apps/web/src/pages/tendering/scope-cards/ScopeCardsTab.tsx'
premise_means: >-
...
scope:
  ...
  - apps/web/src/pages/tendering/scope-cards/**
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/tendering/ScopeQuantitiesTable.tsx apps/web/src/pages/tendering/ScopeWasteTab.tsx apps/web/src/pages/tendering/TenderClarificationLog.tsx apps/web/src/pages/tendering/TenderDocumentsPanel.tsx apps/web/src/pages/tendering/TenderEntriesPanel.tsx apps/web/src/pages/tendering/scope-cards/ScopeCardsTab.tsx
size: 6
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Tendering (part B) - the files slice 1 missed

Slice 2 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (6 files, 15 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/pages/tendering/ScopeQuantitiesTable.tsx`  (1)
- `apps/web/src/pages/tendering/ScopeWasteTab.tsx`  (1)
- `apps/web/src/pages/tendering/TenderClarificationLog.tsx`  (5)
- `apps/web/src/pages/tendering/TenderDocumentsPanel.tsx`  (1)
- `apps/web/src/pages/tendering/TenderEntriesPanel.tsx`  (6)
- `apps/web/src/pages/tendering/scope-cards/ScopeCardsTab.tsx`  (1)
