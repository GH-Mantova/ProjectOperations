---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/compliance/CompliancePage.tsx apps/web/src/pages/dockets/DocketsRegisterPage.tsx apps/web/src/pages/field/FieldDocketPage.tsx apps/web/src/pages/field/FieldDocumentsPage.tsx apps/web/src/pages/field/FieldExpensePage.tsx apps/web/src/pages/field/FieldLeavePage.tsx apps/web/src/pages/field/FieldPreStartPage.tsx apps/web/src/pages/field/FieldSafetyPage.tsx apps/web/src/pages/field/FieldTimesheetPage.tsx'
premise_means: >-
...
scope:
  ...
  - apps/web/src/pages/dockets/**
  - apps/web/src/pages/field/**
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/compliance/CompliancePage.tsx apps/web/src/pages/dockets/DocketsRegisterPage.tsx apps/web/src/pages/field/FieldDocketPage.tsx apps/web/src/pages/field/FieldDocumentsPage.tsx apps/web/src/pages/field/FieldExpensePage.tsx apps/web/src/pages/field/FieldLeavePage.tsx apps/web/src/pages/field/FieldPreStartPage.tsx apps/web/src/pages/field/FieldSafetyPage.tsx apps/web/src/pages/field/FieldTimesheetPage.tsx
size: 9
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Field, dockets, compliance

Slice 3 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (9 files, 25 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/pages/compliance/CompliancePage.tsx`  (3)
- `apps/web/src/pages/dockets/DocketsRegisterPage.tsx`  (2)
- `apps/web/src/pages/field/FieldDocketPage.tsx`  (2)
- `apps/web/src/pages/field/FieldDocumentsPage.tsx`  (1)
- `apps/web/src/pages/field/FieldExpensePage.tsx`  (1)
- `apps/web/src/pages/field/FieldLeavePage.tsx`  (2)
- `apps/web/src/pages/field/FieldPreStartPage.tsx`  (6)
- `apps/web/src/pages/field/FieldSafetyPage.tsx`  (2)
- `apps/web/src/pages/field/FieldTimesheetPage.tsx`  (6)
