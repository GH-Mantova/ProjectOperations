---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/admin/AdminAccessRequestsTab.tsx apps/web/src/pages/admin/AdminCompaniesPage.tsx apps/web/src/pages/admin/AdminCompanyPage.tsx apps/web/src/pages/admin/AdminRolesPermissionsTab.tsx apps/web/src/pages/admin/AdminUsersTab.tsx apps/web/src/pages/admin/ApiKeyVaultPanel.tsx apps/web/src/personas/pages/CompanySettingsTab.tsx apps/web/src/personas/pages/MySettingsTab.tsx apps/web/src/portal/PortalAuthContext.tsx'
premise_means: >-
...
scope:
  ...
  - apps/web/src/personas/pages/**
  - apps/web/src/portal/**
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/admin/AdminAccessRequestsTab.tsx apps/web/src/pages/admin/AdminCompaniesPage.tsx apps/web/src/pages/admin/AdminCompanyPage.tsx apps/web/src/pages/admin/AdminRolesPermissionsTab.tsx apps/web/src/pages/admin/AdminUsersTab.tsx apps/web/src/pages/admin/ApiKeyVaultPanel.tsx apps/web/src/personas/pages/CompanySettingsTab.tsx apps/web/src/personas/pages/MySettingsTab.tsx apps/web/src/portal/PortalAuthContext.tsx
size: 9
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Admin, personas, portal

Slice 6 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (9 files, 45 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/pages/admin/AdminAccessRequestsTab.tsx`  (4)
- `apps/web/src/pages/admin/AdminCompaniesPage.tsx`  (6)
- `apps/web/src/pages/admin/AdminCompanyPage.tsx`  (9)
- `apps/web/src/pages/admin/AdminRolesPermissionsTab.tsx`  (2)
- `apps/web/src/pages/admin/AdminUsersTab.tsx`  (3)
- `apps/web/src/pages/admin/ApiKeyVaultPanel.tsx`  (14)
- `apps/web/src/personas/pages/CompanySettingsTab.tsx`  (3)
- `apps/web/src/personas/pages/MySettingsTab.tsx`  (3)
- `apps/web/src/portal/PortalAuthContext.tsx`  (1)
