...
escalates: false
---
<!-- watcher: DO-NOT-ARM (arm after forms public/kiosk/QR sign-in) | ERP gap D/WHS | muster headcount -->
# HOLD — ERP: live muster / evacuation headcount

STATUS: DRAFTED, STAGED, **DO NOT ARM** until `pr-forms-public-kiosk-qr` has merged (site sign-in feeds the
on-site register). HammerTech parity. Arm after sign-in exists.
