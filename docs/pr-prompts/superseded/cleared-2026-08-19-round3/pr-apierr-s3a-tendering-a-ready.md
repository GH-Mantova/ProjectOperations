---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/tendering/AddClientModal.tsx apps/web/src/pages/tendering/ClientQuotesPanel.tsx apps/web/src/pages/tendering/ConvertToProjectModal.tsx apps/web/src/pages/tendering/QuoteTab.tsx apps/web/src/pages/tendering/ScopeCuttingSheet.tsx apps/web/src/pages/tendering/ScopeListDropdown.tsx'
premise_means: >-
  These 6 web files still feed a raw HTTP response body straight into an error
  message, so the user sees the JSON envelope instead of the message inside it.
scope:
  - apps/web/src/pages/tendering/**
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/tendering/AddClientModal.tsx apps/web/src/pages/tendering/ClientQuotesPanel.tsx apps/web/src/pages/tendering/ConvertToProjectModal.tsx apps/web/src/pages/tendering/QuoteTab.tsx apps/web/src/pages/tendering/ScopeCuttingSheet.tsx apps/web/src/pages/tendering/ScopeListDropdown.tsx
size: 6
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Tendering (part A)

Slice 1 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (6 files, 13 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/pages/tendering/AddClientModal.tsx`  (1)
- `apps/web/src/pages/tendering/ClientQuotesPanel.tsx`  (2)
- `apps/web/src/pages/tendering/ConvertToProjectModal.tsx`  (1)
- `apps/web/src/pages/tendering/QuoteTab.tsx`  (6)
- `apps/web/src/pages/tendering/ScopeCuttingSheet.tsx`  (1)
- `apps/web/src/pages/tendering/ScopeListDropdown.tsx`  (2)
