Use the pr-fix-reviewer agent to review PR #1062 ("docs(plans): SLICE-0 bid-prioritisation plan + BP-1/BP-2 -HOLD prompts") on GH-Mantova/ProjectOperations.
...
2. Write the verdict to docs/pr-reviews/pr-1062-review.md
...
4. If verdict is FIX or BLOCK, also write
   docs/pr-prompts/needs-marco/pr-1062-review-fix.md or
   docs/pr-prompts/needs-marco/pr-1062-review-block.md
