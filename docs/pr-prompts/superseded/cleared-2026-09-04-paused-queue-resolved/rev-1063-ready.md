Use the pr-fix-reviewer agent to review PR #1063 ("docs: bid-prioritisation SLICE-0 plan + 2 chained slice prompts (BP-1..BP-2)") on GH-Mantova/ProjectOperations.
...
2. Write the verdict to docs/pr-reviews/pr-1063-review.md
...
4. If verdict is FIX or BLOCK, also write
   docs/pr-prompts/needs-marco/pr-1063-review-fix.md or
   docs/pr-prompts/needs-marco/pr-1063-review-block.md
