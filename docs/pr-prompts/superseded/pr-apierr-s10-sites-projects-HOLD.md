---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/dashboards/GlobalDashboardPage.tsx apps/web/src/pages/projects/GanttChart.tsx apps/web/src/pages/projects/ProjectDetailPage.tsx apps/web/src/pages/projects/ProjectsListPage.tsx apps/web/src/pages/sites/MusterPage.tsx apps/web/src/pages/sites/SiteDetailPage.tsx apps/web/src/pages/sites/SiteFormModal.tsx apps/web/src/pages/sites/SiteHeadcountWidget.tsx apps/web/src/pages/sites/SitesListPage.tsx'
premise_means: >-
...
scope:
  ...
  - apps/web/src/pages/sites/**
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/dashboards/GlobalDashboardPage.tsx apps/web/src/pages/projects/GanttChart.tsx apps/web/src/pages/projects/ProjectDetailPage.tsx apps/web/src/pages/projects/ProjectsListPage.tsx apps/web/src/pages/sites/MusterPage.tsx apps/web/src/pages/sites/SiteDetailPage.tsx apps/web/src/pages/sites/SiteFormModal.tsx apps/web/src/pages/sites/SiteHeadcountWidget.tsx apps/web/src/pages/sites/SitesListPage.tsx
size: 9
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Sites, projects, global dashboard page

Slice 9 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (9 files, 20 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/pages/dashboards/GlobalDashboardPage.tsx`  (1)
- `apps/web/src/pages/projects/GanttChart.tsx`  (1)
- `apps/web/src/pages/projects/ProjectDetailPage.tsx`  (12)
- `apps/web/src/pages/projects/ProjectsListPage.tsx`  (1)
- `apps/web/src/pages/sites/MusterPage.tsx`  (1)
- `apps/web/src/pages/sites/SiteDetailPage.tsx`  (1)
- `apps/web/src/pages/sites/SiteFormModal.tsx`  (1)
- `apps/web/src/pages/sites/SiteHeadcountWidget.tsx`  (1)
- `apps/web/src/pages/sites/SitesListPage.tsx`  (1)
