---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/contracts/BillingTab.tsx apps/web/src/pages/contracts/ClaimDraftEditor.tsx apps/web/src/pages/contracts/ContractDetailPage.tsx apps/web/src/pages/contracts/ContractsListPage.tsx apps/web/src/pages/contracts/NewContractModal.tsx apps/web/src/pages/forms/CorrectiveActionDetailPage.tsx apps/web/src/pages/forms/CorrectiveActionsPage.tsx apps/web/src/pages/forms/FormFillPage.tsx apps/web/src/pages/forms/FormSubmissionDetailPage.tsx apps/web/src/pages/forms/FormsListPage.tsx'
premise_means: >-
...
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/pages/contracts/BillingTab.tsx apps/web/src/pages/contracts/ClaimDraftEditor.tsx apps/web/src/pages/contracts/ContractDetailPage.tsx apps/web/src/pages/contracts/ContractsListPage.tsx apps/web/src/pages/contracts/NewContractModal.tsx apps/web/src/pages/forms/CorrectiveActionDetailPage.tsx apps/web/src/pages/forms/CorrectiveActionsPage.tsx apps/web/src/pages/forms/FormFillPage.tsx apps/web/src/pages/forms/FormSubmissionDetailPage.tsx apps/web/src/pages/forms/FormsListPage.tsx
size: 10
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Contracts and forms

Slice 7 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (10 files, 47 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/pages/contracts/BillingTab.tsx`  (10)
- `apps/web/src/pages/contracts/ClaimDraftEditor.tsx`  (5)
- `apps/web/src/pages/contracts/ContractDetailPage.tsx`  (10)
- `apps/web/src/pages/contracts/ContractsListPage.tsx`  (3)
- `apps/web/src/pages/contracts/NewContractModal.tsx`  (2)
- `apps/web/src/pages/forms/CorrectiveActionDetailPage.tsx`  (3)
- `apps/web/src/pages/forms/CorrectiveActionsPage.tsx`  (1)
- `apps/web/src/pages/forms/FormFillPage.tsx`  (3)
- `apps/web/src/pages/forms/FormSubmissionDetailPage.tsx`  (3)
- `apps/web/src/pages/forms/FormsListPage.tsx`  (7)
