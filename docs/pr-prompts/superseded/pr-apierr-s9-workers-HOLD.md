---
premise: 'grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/components/contacts/ContactsTab.tsx apps/web/src/components/correspondence/CorrespondencePanel.tsx apps/web/src/components/timeline/Timeline.tsx apps/web/src/pages/timesheets/TimesheetApprovalPage.tsx apps/web/src/pages/workers/AvailabilitySection.tsx apps/web/src/pages/workers/LiveCrewMapPage.tsx apps/web/src/pages/workers/QualificationsSection.tsx apps/web/src/pages/workers/WorkerDetailPage.tsx apps/web/src/pages/workers/WorkersListPage.tsx'
premise_means: >-
...
scope:
  - apps/web/src/components/contacts/**
  - apps/web/src/components/correspondence/**
  - apps/web/src/components/timeline/**
  - apps/web/src/pages/timesheets/**
  - apps/web/src/pages/workers/**
done_when: >-
  pnpm build && pnpm lint && ! grep -lqE "(throw new Error\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\)|setError\(await [A-Za-z_][A-Za-z0-9_]*\.text\(\)\))" apps/web/src/components/contacts/ContactsTab.tsx apps/web/src/components/correspondence/CorrespondencePanel.tsx apps/web/src/components/timeline/Timeline.tsx apps/web/src/pages/timesheets/TimesheetApprovalPage.tsx apps/web/src/pages/workers/AvailabilitySection.tsx apps/web/src/pages/workers/LiveCrewMapPage.tsx apps/web/src/pages/workers/QualificationsSection.tsx apps/web/src/pages/workers/WorkerDetailPage.tsx apps/web/src/pages/workers/WorkersListPage.tsx
size: 9
gate_allow: none
seed_only: false
escalates: false
...
# Humane API errors — Workers, timesheets, shared components

Slice 8 of 10 in the raw-error-envelope migration, plus a final CI-gate slice.
...
## Files in this slice (9 files, 28 occurrences measured on origin/main 15d9b1d3)

- `apps/web/src/components/contacts/ContactsTab.tsx`  (3)
- `apps/web/src/components/correspondence/CorrespondencePanel.tsx`  (2)
- `apps/web/src/components/timeline/Timeline.tsx`  (3)
- `apps/web/src/pages/timesheets/TimesheetApprovalPage.tsx`  (7)
- `apps/web/src/pages/workers/AvailabilitySection.tsx`  (2)
- `apps/web/src/pages/workers/LiveCrewMapPage.tsx`  (3)
- `apps/web/src/pages/workers/QualificationsSection.tsx`  (2)
- `apps/web/src/pages/workers/WorkerDetailPage.tsx`  (4)
- `apps/web/src/pages/workers/WorkersListPage.tsx`  (2)
