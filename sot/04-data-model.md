...
- Last updated: 2026-07-23 16:13 UTC
- Generated from: `apps/api/prisma/schema.prisma` (sha256 `a9a1228fe179`)
- Models: 241 | Enums: 48 | FK edges: 382 | Domains: 23
...
- Table: `users` | Domain: Platform | Fields: 147
- Belongs to (FK out):
  - `createdBy` -> **User** (createdById)
  - `updatedBy` -> **User** (updatedById)
